...
volatile uint8_t g_UartBuff[UART_BUF_MAX_LENGTH];
volatile uint8_t g_sbufHead = 0;
volatile uint8_t g_sbufTail = 0;
...
void uart0_interrupt_isr(void)
{
    ...
    g_UartBuff[g_sbufHead++] = RXD0;
    g_sbufHead = g_sbufHead & UART_BUF_MASK;
